<!-- src/views/sprint/SprintManagementView.vue -->
...
<template>
  <div class="space-y-6">
    ...
    <template v-else>
      ...
      <!-- Filter tabs -->
      <div v-if="sprints.length > 0" class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <template v-for="sprint in filteredSprints" :key="sprint.id">
          <!-- Sprint Card -->
          <SprintCard
            :sprint="sprint"
...
import SprintCard from '@/components/features/sprint/SprintCard.vue';
import SprintStats from '@/components/features/sprint/SprintStats.vue';
